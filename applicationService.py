...
class MyService(Service):
	...
	self.application_command  = ["spark-submit", "--driver-java-options", '"-Dlog4j.configuration=file:src/main/python/dictionary/configuration/log4j.properties"', "--master", "yarn", "--conf", "spark.driver.memory=24g", "--num-executors", "25", "--executor-memory", "14g", "--executor-cores", "4", "--py-files", "dq_machine.zip" , "--packages",  "mysql:mysql-connector-java:5.1.39 src/main/python/main.py", "0"]
